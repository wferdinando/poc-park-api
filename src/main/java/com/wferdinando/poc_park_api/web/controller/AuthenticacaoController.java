...
public class AuthenticacaoController {
    ...
    @Operation(summary = "Autenticar na API.", description = "Recurso para autenticação na API.", responses = {
            @ApiResponse(responseCode = "200", description = "Autenticação realizadas com sucesso, e retorno de Bearer Token", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsuarioResponseDTO.class))),
